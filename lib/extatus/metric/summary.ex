defmodule Extatus.Metric.Summary do
  @moduledoc """
  ...
  defmacro new(name) do
    ...
    metric = @metric
    quote do
      require Prometheus.Metric.Summary
      name = unquote(name)
  ...
  @doc """
  Creates a summary using the `name` of a `metric`. If the counter exists,
  returns false.
  """
  ...
  @doc """
  Observes the given `amount` for the summary identified by `name` and
  ...
  @doc """
  Observes the summary identified by `name` and `values` (keyword list with
  ...
  @doc """
  Removes summary series identified by `name` and `values` (keyword list with
  ...
  @doc """
  Resets the value of the summary identified by `name` and `values`
  ...
  @doc """
  Returns the value of the summary identified by `name` and `values`
  (keyword list with the correspondence between labels and values).
  """
